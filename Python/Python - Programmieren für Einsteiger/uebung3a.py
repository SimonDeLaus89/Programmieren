...
def main():
    ...
    print("List: \n--------------------------------")
    print("Titel: {}".format(buch1List[0]))
    print("Autor: {}".format(buch1List[1]))
    print("Artikelnummer: {}".format(buch1List[2]))
    print("Preis: {}\n".format(buch1List[3]))
    print("Titel: {}".format(buch2List[0]))
    print("Autor: {}".format(buch2List[1]))
    print("Artikelnummer: {}".format(buch2List[2]))
    print("Preis: {}\n".format(buch2List[3]))
    print("Titel: {}".format(buch3List[0]))
    print("Autor: {}".format(buch3List[1]))
    print("Artikelnummer: {}".format(buch3List[2]))
    print("Preis: {}\n".format(buch3List[3]))

    print("Dict: \n--------------------------------")
    print("Titel: {}".format(buch1Dict["Titel"]))
    print("Autor: {}".format(buch1Dict["Autor"]))
    print("Artikelnummer: {}".format(buch1Dict["Artikelnummer"]))
    print("Preis: {}\n".format(buch1Dict["Preis"]))
    print("Titel: {}".format(buch2Dict["Titel"]))
    print("Autor: {}".format(buch2Dict["Autor"]))
    print("Artikelnummer: {}".format(buch2Dict["Artikelnummer"]))
    print("Preis: {}\n".format(buch2Dict["Preis"]))
    print("Titel: {}".format(buch3Dict["Titel"]))
    print("Autor: {}".format(buch3Dict["Autor"]))
    print("Artikelnummer: {}".format(buch3Dict["Artikelnummer"]))
    print("Preis: {}\n".format(buch3Dict["Preis"]))


    print("Tuple: \n--------------------------------")
    print("Titel: {}".format(buch1Tuple[0]))
    print("Autor: {}".format(buch1Tuple[1]))
    print("Artikelnummer: {}".format(buch1Tuple[2]))
    print("Preis: {}\n".format(buch1Tuple[3]))
    print("Titel: {}".format(buch2Tuple[0]))
    print("Autor: {}".format(buch2Tuple[1]))
    print("Artikelnummer: {}".format(buch2Tuple[2]))
    print("Preis: {}\n".format(buch2Tuple[3]))
    print("Titel: {}".format(buch3Tuple[0]))
    print("Autor: {}".format(buch3Tuple[1]))
    print("Artikelnummer: {}".format(buch3Tuple[2]))
    print("Preis: {}\n".format(buch3Tuple[3]))
